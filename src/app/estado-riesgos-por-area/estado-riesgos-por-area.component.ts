...
@Component({
  selector: 'app-estado-riesgos-por-area',
  templateUrl: './estado-riesgos-por-area.component.html',
  styleUrls: ['./estado-riesgos-por-area.component.css']
})
export class EstadoRiesgosPorAreaComponent  {
  iniciativas: Epic[] = [];
