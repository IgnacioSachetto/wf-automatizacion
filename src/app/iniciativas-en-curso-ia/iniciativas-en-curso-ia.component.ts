...
@Component({
  ...
  templateUrl: './iniciativas-en-curso-ia.component.html',
  styleUrls: ['./iniciativas-en-curso-ia.component.css']
})
export class IniciativasEnCursoIAComponent implements OnInit {
  iniciativas: Epic[] = [];
